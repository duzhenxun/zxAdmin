...
<?php echo W('PageHeader',array('name'=>'控制台'));?>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="alert alert-block alert-success">
            ...
            欢迎进入zx后台管理系统， 当前版本号：<?php echo C('version');?> 
        </div>
            ...
            <div class="col-sm-12 infobox-container">
                ...
                <div class="infobox infobox-blue">
                    ...
                    <div class="infobox-data">
                        <span class="infobox-data-number"><?php echo ($count["user_all"]); ?></span>
                        <div class="infobox-content">会员总数</div>
                    </div>       
                </div>
                ...
                <div class="infobox infobox-blue">
                    ...
                    <div class="infobox-data">
                        <span class="infobox-data-number"><?php echo getCount('user',"status=1 and wrlogin!=0 and add_time > ".$time['today']);?></span>
                        <div class="infobox-content">今天新增</div>
                    </div>       
                </div>
                ...
                <div class="infobox infobox-blue">
                    ...
                    <div class="infobox-data">
                        <span class="infobox-data-number"><?php echo ($count["user_yesterday"]); ?></span>
                        <div class="infobox-content">昨天新增</div>
                    </div>       
                </div>
                ...
                <div class="infobox infobox-blue">
                    ...
                    <div class="infobox-data">
                        <span class="infobox-data-number"><?php echo ($count["user_monday"]); ?></span>
                        <div class="infobox-content">30天内新增</div>
                    </div>       
                </div>
