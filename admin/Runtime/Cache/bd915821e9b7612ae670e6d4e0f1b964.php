...
<div class="col-sm-6 pull-right">
    <button class="btn btn-sm btn-primary pull-right" onclick="javascript:window.location.href = '?m=<?php echo ($mod); ?>&a=add'">
        新增
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>  
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs btn-group">
                                    <button class="btn btn-xs btn-info" onclick="window.location.href = '?m=<?php echo ($mod); ?>&a=add&id=<?php echo ($v["id"]); ?>'">
                                        <i class="ace-icon fa fa-pencil bigger-120" ></i>
                                    </button>

                                    <button class="btn btn-xs btn-danger" <?php if(($v["id"] != 1)): ?>onclick="alert_del('?m=<?php echo ($mod); ?>&a=del&id=<?php echo ($v["id"]); ?>','确认要删除『<?php echo ($v["username"]); ?>』吗？')"<?php endif; ?>>
                                ...
                                <div class="hidden-md hidden-lg">
                                    <div class="inline position-relative">
                                        ...
                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                            <li>
                                                <a href="?m=<?php echo ($mod); ?>&a=add&id=<?php echo ($v["id"]); ?>" class="tooltip-info" data-rel="tooltip" title="View">
                                                    <span class="blue">
                                            ...
                                            <?php if(($v["id"] != 1)): ?><li>
                                                    <a href="#" class="tooltip-error" data-rel="tooltip" title="Delete" onclick="return alert_del('?m=<?php echo ($mod); ?>&a=del&id=<?php echo ($v["id"]); ?>', '确认要删除『<?php echo ($v["username"]); ?>』吗？');">
                                                        <span class="red">
                                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                        </span>
                                                    </a>
