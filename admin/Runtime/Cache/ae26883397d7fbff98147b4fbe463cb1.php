    ...
    <form name="myform" action=""  method="GET" >
        <div class="panel-body">
            <div class="pull-left">
                ...
                管理员：<input type="text" name="name" value="<?php echo ($_GET['name']); ?>">
               
                <button type="button" class="btn btn-purple btn-sm" onclick="myform.submit();">
                    Search
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="dataTables_info" id="sample-table-2_info">
                            ...
                            <?php if(($_SESSION['auth_id']== 1)): ?><span class="btn btn-sm" onclick="window.location.href='?m=<?php echo ($mod); ?>&a=del_admin_log'">清空</span><?php endif; ?>
                        </div>
                    </div>
                    <div class="col-sm-10">
