            ...
            <div class="col-xs-12 col-sm-4">
                <div class="widget-box">
                    <div class="widget-header">
                        <h4 class="widget-title">金币奖励说明</h4>
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <textarea class="form-control" name="system[coins_log]" rows="15"><?php if(is_array($data["coins_log"])): foreach($data["coins_log"] as $key=>$v): echo ($key); ?>|<?php echo ($v); ?>&#13;&#10;<?php endforeach; endif; ?></textarea>
                        </div>
                    </div>
                </div>
            </div><!-- /.span -->
             <div class="col-xs-12 col-sm-4">
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <textarea class="form-control" name="system[sports_type_task]" rows="15"><?php if(is_array($data["sports_type_task"])): foreach($data["sports_type_task"] as $key=>$v): echo ($key); ?>|<?php echo ($v); ?>&#13;&#10;<?php endforeach; endif; ?></textarea>
                        </div>
                    </div>
                </div>
            </div><!-- /.span -->
             ...
             <div class="col-xs-12 col-sm-4">
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <textarea class="form-control" name="system[monitoring_equipment]" rows="15"><?php if(is_array($data["monitoring_equipment"])): foreach($data["monitoring_equipment"] as $key=>$v): echo ($key); ?>|<?php echo ($v); ?>&#13;&#10;<?php endforeach; endif; ?></textarea>
                        </div>
                    </div>
                </div>
            </div><!-- /.span -->
             ...
             <div class="col-xs-12 col-sm-12">
                <div class="widget-box">
                    <div class="widget-header">
                        <h4 class="widget-title">PATH 设置</h4>
                        <div class="widget-toolbar">
                            <a href="#" data-action="collapse">
                                <i class="ace-icon fa fa-chevron-up"></i>
                            </a>
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <textarea class="form-control" name="system[path]" rows="5"><?php if(is_array($data["path"])): foreach($data["path"] as $key=>$v): echo ($key); ?>|<?php echo ($v); ?>&#13;&#10;<?php endforeach; endif; ?></textarea>
                        </div>
                    </div>
                </div>
            </div><!-- /.span -->
