            ...
            <form action="" method="post" name="myform" class="form-horizontal">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="realname"  value="<?php echo ($data["realname"]); ?>"  class="col-xs-10 col-sm-5">
                        <span class="help-inline col-xs-12 col-sm-7">
                            <span class="middle">*请输入真实姓名</span>
                        </span>
                    </div>
                </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="email"  value="<?php echo ($data["email"]); ?>"  class="col-xs-10 col-sm-5">
                        <span class="help-inline col-xs-12 col-sm-7">
                            <span class="middle">*请输入邮箱地址</span>
                        </span>
                    </div>
                </div>
