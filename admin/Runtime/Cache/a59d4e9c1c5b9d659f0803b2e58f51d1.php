        ...
        <div class="widget-main">
            <form action="" method="post" name="myform" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="name" value="<?php echo ($data["name"]); ?>" class="col-xs-10 col-sm-5">
                        <span class="help-inline col-xs-12 col-sm-7">
                            <span class="middle">*请输入菜单名称</span>
                        </span>
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 文件名 </label>
                    <div class="col-sm-9">
                        <input type="text" name="mod"  value="<?php echo ($data["mod"]); ?>"  class="col-xs-10 col-sm-5">
                        <span class="help-inline col-xs-12 col-sm-7">
                            <span class="middle">*首字母大写(m)</span>
                        </span>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 方法名 </label>
                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" name="act"  value="<?php echo ($data["act"]); ?>" >
                        <span class="help-inline col-xs-12 col-sm-7">
                            <span class="middle">*请输入方法名(a)</span>
                        </span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"  name="data"  class="col-xs-10 col-sm-5"  value="<?php echo ($data["data"]); ?>" >
                        <span class="help-inline col-xs-12 col-sm-7">
                            <span class="middle">请输入附加参数(name=duzhenxun)</span>
                        </span>
                    </div>
                </div>  
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"  name="icon" class="col-xs-10 col-sm-5"  value="<?php echo ($data["icon"]); ?>" >
                    </div>
                </div>


                <?php if($_GET["id"] > 0): ?><input type='hidden' name='id' value="<?php echo ($_GET["id"]); ?>">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 是否显示菜单 </label>
                        <div class="col-sm-9">
                            <input type="radio" class="ace" name="status" value="1" <?php if($data["status"] == 1): ?>checked<?php endif; ?> > <span class="lbl"> 是 </span>
                            <input type="radio" class="ace" name="status" value="2" <?php if($data["status"] == 2): ?>checked<?php endif; ?> > <span class="lbl"> 否 </span>
                        </div>
                    </div><?php endif; ?> 
